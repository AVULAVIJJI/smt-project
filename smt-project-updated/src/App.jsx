    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/employee"       element={<EmployeeLayout />}>
          ...
          <Route path="my-data/attendance" element={<SectionPage />} />
          ...
          <Route path="finance/reimbursement" element={<SectionPage />} />
          ...
          {/* IT */}
          <Route path="it/helpdesk" element={<SectionPage />} />
          ...
          <Route path="misc/announcements"  element={<SectionPage />} />
